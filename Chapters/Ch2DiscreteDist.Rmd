...
- <a href="javascript://"  title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="The assignment operator  is analogous to an equal sign in mathematics.", style="color:green;">`<-`</a>
...
This section shows how to compute and graph probability mass and distribution function for the negative binomial distribution. You will also learn how to plot two functions on the same graph.
...
* <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Function used to get or assign names of an object. In this illustration, it was used to get the variables names.", style="color:green;">`names()`</a>
...
If we had to guess, from this plot we might say that the maximum value of the log likelihood was around 0.7. From calculus, we know that the maximum likelihood estimator 
...
* <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Function used to get or assign names of an object. In this illustration, it was used to get the variables names.", style="color:green;">`names()`</a>
 <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Function used to retrieve or set the dimension of an object.", style="color:green;">`dim()`</a>
 <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="When you attach a dataset using the `attach()` function, variable names in the database can be accessed by simply giving their names.", style="color:green;">`attach()`</a>
...
* <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Function used to fit generalized linear models.", style="color:green;">`glm()`</a>
 <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="See this for other modeling options.", style="color:green;">`help(glm)`</a>
 <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Function used in order to get the results.", style="color:green;">`summary()`</a>
 <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="In the output, this reminds us what model we ran and what options were specified.", style="color:green;">`call`</a>
 <a href="javascript://" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Shows the distribution of the deviance residuals for individual cases used in the model.", style="color:green;">`Deviance Residuals`</a>
* The next part of the output shows the coefficient (maximum likelihood estimate of $\log(\lambda)$), its standard error, the z-statistic and the associated p-value. 
